...
{
    [SerializeField, BoxGroup("Chunk")]
    private int fieldSize = 100;
    [SerializeField, BoxGroup("Chunk")]
    private int chunkDensity = 1;
    [SerializeField, BoxGroup("Chunk")]
    private int numChunks = 1;

    [SerializeField, BoxGroup("General")]
    private float displacementStrength = 200.0f;
    [SerializeField, BoxGroup("General")]
    private Material grassMaterial;
    [SerializeField, BoxGroup("General")]
    private Mesh grassMesh;
    [SerializeField, BoxGroup("General")]
    private Mesh grassLODMesh;
    [SerializeField, BoxGroup("General")]
    private Texture heightMap;


    [SerializeField, BoxGroup("LOD"), Range(0, 1000.0f)]
    private float lodCutoff = 1000.0f;
    [SerializeField,BoxGroup("LOD"), Range(0, 1000.0f)]
    private float distanceCutoff = 1000.0f;

    [SerializeField, BoxGroup("Wind")]
